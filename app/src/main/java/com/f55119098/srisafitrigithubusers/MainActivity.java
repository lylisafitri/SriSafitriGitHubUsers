package com.f55119098.srisafitrigithubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of GitHub Users | F55119098");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
